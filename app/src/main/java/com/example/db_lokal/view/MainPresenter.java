...
public class MainPresenter implements MainContact.presenter {
    ...
    @Override
    public void insertData(String tanggal, int pemasukankotor, int pengeluaran, AppDatabase database) {
        final DataKampus dataKampus = new DataKampus();
        dataKampus.setTanggal(tanggal);
        dataKampus.setPemasukankotor(pemasukankotor);
        dataKampus.setPengeluaran(pengeluaran);
    ...
    @Override
    public void editData(String tanggal, int pemasukankotor, int pengeluaran, int id, AppDatabase database) {
        final DataKampus dataKampus = new DataKampus();
        dataKampus.setTanggal(tanggal);
        dataKampus.setPemasukankotor(pemasukankotor);
        dataKampus.setPengeluaran(pengeluaran);
    ...
    @Override
    public void deleteData(DataKampus dataKampus, AppDatabase database) {
